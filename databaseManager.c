...
int main(int argc, char* argv[]) {
  ...
  insert_reservation("AA954", "30C", "John Doe");
  insert_reservation("AA954", "41C", "John Doe");
  insert_reservation("AA954", "04C", "John Doe");
  insert_reservation("AA954", "01C", "John Doe");
  insert_reservation("AA954", "40A", "John Doe");
  insert_reservation("AA954", "40B", "John Doe");
  insert_reservation("AA954", "40D", "John Doe");
  insert_reservation("AA954", "29E", "John Doe");
